  ...
  <body>
    ...
    <main class="text-base overflow-auto bg-cover w-full h-full">
        <div id='vv' class="w-full py-3 sm:w-9/12 max-w-4xl text-center mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" width="140mm" height="25mm" viewBox="0 0 179 46" version="1.1" role="img" aria-label="Vael Victus">
                <defs>
                  ...
                  <g mask="url(#signature_reveal_mask)">
                    <g aria-label="Vael Victus" style="font-size:38.1px;line-height:1.25;font-family:Charm;stroke-width:0.264583;fill:currentColor;" transform="translate(-12.700002,1.5875)">
